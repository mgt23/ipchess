...
func (x *ChallengeRequest) GetCommitment() []byte {
	if x != nil {
		return x.Commitment
	}
	return nil
...
func (x *ChallengeRequestResponse) Reset() {
	*x = ChallengeRequestResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ChallengeRequestResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChallengeRequestResponse) ProtoMessage() {}

func (x *ChallengeRequestResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_ipchess_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChallengeRequestResponse.ProtoReflect.Descriptor instead.
func (*ChallengeRequestResponse) Descriptor() ([]byte, []int) {
	return file_proto_ipchess_proto_rawDescGZIP(), []int{2}
}

func (x *ChallengeRequestResponse) GetRandomBytes() []byte {
	if x != nil {
...
var file_proto_ipchess_proto_rawDesc = []byte{
	...
	,
...
var file_proto_ipchess_proto_goTypes = []interface{}{
	...
	(*ChallengeRequestResponse)(nil),    // 2: ipchess.ChallengeRequestResponse
...
func file_proto_ipchess_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_ipchess_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ChallengeRequestResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
